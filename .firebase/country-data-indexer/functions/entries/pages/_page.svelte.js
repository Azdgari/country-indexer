import { c as create_ssr_component, a as validate_component, b as add_attribute, d as each, e as escape } from "../../chunks/ssr.js";
import "theme-change";
const data = [
  {
    name: "Afghanistan",
...
const DarkMode = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<label class="swap swap-rotate"> <input type="checkbox" class="theme-controller" value="garden">  <svg class="swap-on fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"></path></svg>  <svg class="swap-off fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"></path></svg></label>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let selectedRegion = "";
  let regions = ["None", "Africa", "Americas", "Asia", "Europe", "Oceania"];
  let search = "";
  const filteredCountries = (selectedRegion2, search2) => {
    if (!data)
      return [];
    let result = data;
    if (selectedRegion2 !== "None" && selectedRegion2 !== "") {
      result = result.filter((item) => item.region === selectedRegion2);
    }
    if (search2 !== "") {
      result = result.filter((item) => item.name.toLowerCase().includes(search2.toLowerCase()));
    }
    return result;
  };
  let myModal;
  return `<main><header class="flex justify-between px-14 py-5 bg-dark-mode-elements"><button class="font-bold text-dark-mode-text" data-svelte-h="svelte-k8pf7w">Where in the world?</button> ${validate_component(DarkMode, "ThemeSwap").$$render($$result, {}, {}, {})}</header> <section class="mx-14"><div class="filter justify-between my-10 md:flex gap-10"> <input class="input input-bordered flex-2 min-w-96 px-8 h-12 bg-dark-mode-elements rounded-sm" type="text" placeholder="Search for a country..."${add_attribute("value", search, 0)}>  <select class="dropdown select mt-8 md:mt-0 select-bordered w-72 max-w-xs bg-dark-mode-elements rounded-sm"><option value="" disabled selected data-svelte-h="svelte-2ogxqk">Filter by Region</option>${each(regions, (region) => {
    return `<option${add_attribute("value", region, 0)}>${escape(region)}</option>`;
  })}</select></div>  <section class="flex flex-wrap gap-20 justify-center">${each(filteredCountries(selectedRegion, search), (item) => {
    return `<button class="card w-72 flex h-96 flex-col shadow-xl rounded-md cursor-pointer"><div class="w-full relative"><img${add_attribute("width", 264, 0)}${add_attribute("height", 160, 0)} class="h-full w-full rounded-t-md object-cover aspect-[264/160]"${add_attribute("src", item.flags.png, 0)} alt="flag"></div> <div class="card-body text-left h-1/2"><h2 class="card-title">${escape(item.name)}</h2> <p><strong data-svelte-h="svelte-vxfh5n">Population:</strong> ${escape(item.population.toLocaleString("en-US"))}</p> <p><strong data-svelte-h="svelte-k45wo4">Region:</strong> ${escape(item.region)}</p> <p><strong data-svelte-h="svelte-ggynh2">Capital:</strong> ${item.capital !== void 0 ? `${escape(item.capital)}` : `N/A`} </p></div> </button>`;
  })}</section></section>  <dialog class="modal w-full"${add_attribute("this", myModal, 0)}>${``} <form method="dialog" class="modal-backdrop"><button data-svelte-h="svelte-f9j85e">close</button></form></dialog></main>`;
});
export {
  Page as default
};
